...
export const metadata: Metadata = {
  ...
  title: 'Sneakers — Premium Footwear Store',
  description:
    'Shop premium sneakers for men and women. Free shipping on orders over $50. Up to 50% off select styles. Quality footwear crafted for life in motion.',
  icons: {
